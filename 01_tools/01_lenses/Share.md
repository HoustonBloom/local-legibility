...
First production frames live in `03_outbox/frames/` once you start running cuts. Use them to validate the lens end-to-end.
...
- **v0.1.0** (2026-04-20): Initial spec. Preview-forward lens distinct from Reel · Digest Mode. Two opener modes (bluff / categories). Three display modes (inline / iframe / summary). Synthesis recap with threads and action-chip bookkeeping.
