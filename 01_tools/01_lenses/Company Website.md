...
- **Window:** the bundled HTML deliverable (e.g. `03_outbox/<Your Project>.html`)
- **Frames:** one HTML file per page, named with date prefix (e.g. `03_outbox/frames/YYYYMMDD_<your-project>-<page>.html`)
...
- **Window manifest:** `03_outbox/_window-<YourProject>.md` (lists frames + tab order)
...
- Each page is a self-contained HTML file in `03_outbox/frames/`
...
1. Copy `build-window-frames.mjs` to your `03_outbox/` folder, rename to fit (e.g. `build-window.mjs`).
